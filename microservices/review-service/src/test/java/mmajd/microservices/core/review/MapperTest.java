...
import mmajd.microservices.core.review.services.ReviewMapper;
...
class MapperTests {
    ...
    void mapperListTests() {
        ...
        List<ReviewEntity> entityList = mapper.apiListToEntitiesList(apiList);
        ...
        List<Review> api2List = mapper.entitiesListToApiList(entityList);
